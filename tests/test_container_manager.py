...
class TestContainerManager:
    ...
    def test_create_sandbox_session_npx(self, mock_sandbox, container_manager, mock_server):
        ...
        assert call_args['runtime_config']['environment'] == {"API_KEY": "test-key", "ENV_VAR": "test-value"}
    ...
    @patch('mcp_router.container_manager.SandboxSession')
    def test_create_sandbox_session_without_template(self, mock_sandbox, container_manager, mock_server):
    ...
    def test_pull_server_image_npx(self, mock_get_server, container_manager, mock_server):
        ...
        container_manager.docker_client.images.pull.assert_called_once_with(container_manager.node_image)
    ...
    @patch('mcp_router.container_manager.SandboxSession')
    def test_run_server_in_sandbox_success(self, mock_sandbox_class, container_manager, mock_server):
